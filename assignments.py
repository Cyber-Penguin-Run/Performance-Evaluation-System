...
def assignments(auth_data = None):
    ...
    return render_template('assignments.html', assignments_form=assignment_result, auth_data=auth_data, nav_columns=nav_columns)
...
def assignmentform(auth_data = None):
    ...
    if request.method=='GET':    
        ...
        return render_template('coach_assignments.html', assignment_form=results, auth_data=auth_data, nav_columns= nav_columns)


@app.route('/coach/assignments/all', methods=['POST'])
@secure_site
def assignments_all(auth_data = None):
    formsearch = db.query('SELECT * FROM assignments')
    return render_template('coach_assignments.html', assignment_form=formsearch, auth_data=auth_data, nav_columns= nav_columns)


@app.route('/coach/assignments/Quizzes', methods=['POST'])
@secure_site
...
@app.route('/coach/assignments/Exams', methods=['POST'])
@secure_site
...
@app.route('/coach/assignments/Homeworks', methods=['POST'])
@secure_site
...
@app.route('/coach/assignments/Papers', methods=['POST'])
@secure_site
